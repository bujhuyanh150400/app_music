...
const app = {
    ...
    songs: [
        ...
        {
            name: '1 điều mà anh rất ngại nói ra',
            singer: 'Haisam',
            path: './assets/music/1dieumaanhratngainoira.mp3',
            image: './assets/img/1_dieu_ma_anh_rat_ngai_noi_ra.jpg'
        },
        {
            name: 'Chưa bao giờ',
            singer: 'Hà Anh Tuấn',
            path: './assets/music/chuabaogio.mp3',
            image: './assets/img/chua_bao_gio.jpg'
        },
        {
            name: 'Close eyes',
            singer: 'DVRST',
            path: './assets/music/Close_eyes.mp3',
            image: './assets/img/close_eye.jpg'
        },
        {
            name: 'Em có đợi tin nhắn tôi không',
            singer: 'Haisam',
            path: './assets/music/emcodoitinnhantoikhong.mp3',
            image: './assets/img/em_co_doi_tin_nhan_toi_khong.jpg'
        },
        {
            name: 'Can u feel my heart',
            singer: 'Gigachad',
            path: './assets/music/canufeelme.mp3',
            image: './assets/img/can_u_feel_my_heart.jpg'
        },
        {
            name: 'Phonky Town',
            singer: 'Gigachad',
            path: './assets/music/fonkytown.mp3',
            image: './assets/img/phonky_town.jpg'
        },
    ],
